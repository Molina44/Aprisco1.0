    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <ul class="nav-list">
                ...
                <!-- Menú Razas - CORREGIDO -->
                <li class="nav-item has-submenu <?php 
                    $isRazas = strpos($_SERVER['REQUEST_URI'], '/razas') !== false;
                    echo $isRazas ? 'active expanded' : ''; 
                ?>">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="submenu-item <?php 
                            $isRazasList = strpos($_SERVER['REQUEST_URI'], '/razas') !== false && 
                                          strpos($_SERVER['REQUEST_URI'], '/create') === false &&
                                          strpos($_SERVER['REQUEST_URI'], '/stats') === false;
                            echo $isRazasList ? 'active' : ''; 
                        ?>">
                            <a href="<?php echo BASE_URL; ?>/razas" class="submenu-link">
                                <div class="submenu-icon">
                                    <i class="fas fa-list"></i>
                                </div>
                                <span class="submenu-text">Lista de Razas</span>
                            </a>
                        </li>
                        <li class="submenu-item <?php echo (strpos($_SERVER['REQUEST_URI'], '/razas/stats') !== false) ? 'active' : ''; ?>">
                            <a href="<?php echo BASE_URL; ?>/razas/stats" class="submenu-link">
                                <div class="submenu-icon">
...
<style>
    ...
    .logo-image {
    width: 240px;      /* Puedes ajustar esto según el tamaño ideal */
    height: 240px;     /* O usa 'auto' para mantener proporción */
    object-fit: contain;
